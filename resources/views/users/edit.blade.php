                ...
                <form method="POST" action="/users/mypage">
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            <label for="name" class="text-md-left laravel-ec-edit-user-info-label">氏名</label>
                            <span onclick="switchEditUserInfo('.userName', 'editUserName', 'userNameEditLabel');" class="userNameEditLabel user-edit-label">編集</span>
                        </div>
                        <div class="collapse show userName">
                            <h1 class="laravel-ec-edit-user-info-value">{{ $user->name }}</h1>
                        </div>
                        <div class="collapse editUserName">
                            ...
                            <button type="submit" class="btn laravel-ec-submit-button mt-3 w-25">保存</button>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            <label for="email" class="text-md-left laravel-ec-edit-user-info-label">メールアドレス</label>
                        ...
                        <div class="collapse show userMail">
                            <h1 class="laravel-ec-edit-user-info-value">{{ $user->email }}</h1>
                        </div>
                        <div class="collapse editUserMail">
                            ...
                            <button type="submit" class="btn laravel-ec-submit-button mt-3 w-25">
                                保存
                            </button>
                    ...
                    <div class="form-group">
                        <div class="d-flex justify-content-between">
                            <label for="phone" class="text-md-left laravel-ec-edit-user-info-label">電話番号</label>
                        ...
                        <div class="collapse show userPhone">
                            <h1 class="laravel-ec-edit-user-info-value">{{ $user->phone }}</h1>
                        </div>
